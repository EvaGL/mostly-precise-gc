...
extern std::vector <void *> ptr_in_heap; /*< list of ptrs in heap*/

extern ptr_list* all_ptr; /*< all created ptrs*/
...
void mark_and_sweep () {
	...
	for (ptr_list* root = all_ptr; root != 0; root = root->next) {  /*< walk through all ptrs in stack*/
